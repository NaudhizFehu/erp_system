...
import { formToApiRequest, formatCurrency, formatDate } from '@/lib/utils/journalEntry'
...
export default function TransactionList() {
  ...
  // 데이터 조회
  const { data, isLoading, refetch } = useTransactionSearch(debouncedSearchTerm, {
    page,
    size,
    transactionType: transactionType !== 'ALL' ? transactionType as TransactionType : undefined,
    transactionStatus:
      transactionStatus !== 'ALL' ? transactionStatus as TransactionStatus : undefined,
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setTransactionStatus(value as TransactionStatus | 'ALL')}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="전체" />
                  </SelectTrigger>
