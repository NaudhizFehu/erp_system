...
import { EmploymentStatus, KOREAN_LABELS } from '@/types/hr'
...
export function EmployeeManagement() {
  ...
  const [selectedCompanyForExport, setSelectedCompanyForExport] = useState<
    number | undefined
  >()
  const [selectedCompanyForImport, setSelectedCompanyForImport] = useState<
    number | undefined
  >()
  ...
  // 권한 체크
  const { canView, canEdit, canManage, canCreate, canDelete } =
    useHrPermissions()
  ...
  const { positionStats, departmentStats, genderStats, ageGroupStats } =
    useEmployeeStatistics()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">재직/휴가/휴직/정직</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">현재 출근 근무 중</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">퇴사 처리 완료</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">생일 축하 대상</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            >
              <RefreshCw
                className={`h-4 w-4 ${isLoadingEmployees ? 'animate-spin' : ''}`}
              />
            </Button>
          </div>
        </CardContent>
                ...
                <div className="flex items-center space-x-1">
                  {Array.from(
                    ...
                    (_, i) => {
                      ...
                      if (pageNum < 0 || pageNum >= employeesData.totalPages)
                        return null
      ...
      <Dialog open={showImportDialog} onOpenChange={setShowImportDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>가져올 파일을 선택하세요</DialogDescription>
          </DialogHeader>
            ...
            {currentUser?.role === 'SUPER_ADMIN' && (
              <div>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    setSelectedCompanyForImport(Number(value))
                  }
                >
                  <SelectTrigger>
      ...
      <Dialog
        ...
        onOpenChange={setShowImportResultDialog}
      >
        <DialogContent>
          <DialogHeader>
          ...
          {importResult && (
            <div className="space-y-4">
              ...
              {importResult.errors.length > 0 && (
                <div>
                  <p className="mb-2 text-sm font-medium">에러 목록</p>
                  <div className="max-h-48 overflow-y-auto rounded border p-2">
                    {importResult.errors.map((error, index) => (
                      <p key={index} className="py-1 text-sm text-red-600">
                        {error}
                      </p>
                    ))}
                  </div>
