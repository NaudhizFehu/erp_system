...
export const ACCOUNTING_QUERY_KEYS = {
  ...
  accountBalance: (accountId: number, asOfDate?: string) =>
    [
      ...ACCOUNTING_QUERY_KEYS.accounts,
      accountId,
      'balance',
      asOfDate,
    ] as const,
  ...
  trialBalance: (companyId: number, startDate: string, endDate: string) =>
    [
      ...ACCOUNTING_QUERY_KEYS.accounting,
      'trial-balance',
      companyId,
      startDate,
      endDate,
...
export function useTrialBalance(
  ...
  return useQuery({
    ...
    queryFn: () =>
      accountingApi.generateTrialBalance(companyId, startDate, endDate),
    enabled: !!companyId && !!startDate && !!endDate,
    staleTime: 10 * 60 * 1000,
    retry: 3,
  })
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: ACCOUNTING_QUERY_KEYS.transactions,
      })
      queryClient.invalidateQueries({
        queryKey: ACCOUNTING_QUERY_KEYS.accounting,
      })
      toast.success('복식부기 분개가 성공적으로 생성되었습니다')
    },
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '복식부기 분개 생성에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useUpdateTransaction() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '거래 수정에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useApproveTransaction() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '거래 승인에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function usePostTransaction() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '거래 전기에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useCancelTransaction() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '거래 취소에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useGenerateBalanceSheet() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      reportApi.generateBalanceSheet(
        companyId,
        fiscalYear,
        fiscalPeriod,
        baseDate
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '재무상태표 생성에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useGenerateIncomeStatement() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      reportApi.generateIncomeStatement(
        companyId,
        fiscalYear,
        fiscalPeriod,
        startDate,
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '손익계산서 생성에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useApproveReport() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '보고서 승인에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useDeleteReport() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '보고서 삭제에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useCloseFiscalPeriod() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '회계기간 마감에 실패했습니다'
      toast.error(message)
    },
  })
}
...
export function useCloseFiscalYear() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error.response?.data?.message || '회계연도 마감에 실패했습니다'
      toast.error(message)
    },
  })
}
